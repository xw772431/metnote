...
public class SwaggerConfiguration {
    ...
    public Docket haloDefaultApi() {
        ...
        return buildApiDocket("com.metnote.content.api",
                "com.metnote.controller.content.api",
                "/api/content/**")
    ...
    public Docket haloAdminApi() {
        ...
        return buildApiDocket("com.metnote.admin.api",
                "com.metnote.controller.admin",
                "/api/admin/**")
